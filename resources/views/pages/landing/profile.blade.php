<x-layouts.landing title="Profil | {{ config('app.name') }}">
    ...
    <div class="flex min-h-screen flex-col items-center justify-center bg-cstm-green-50">
        <div class="relative z-0 flex w-full max-w-screen-xl px-5 py-10 2xl:max-w-screen-2xl">
            ...
            <div
                ...
                <p
                    title="Tahun 2012 Pemda Kaur memfasilitasi peserta didik yang mempunyaisemangatbelajar yang tinggi untuk mendapatkan layananpendidikan  yang baik, maka dibangunlah SMAN 10 Pentagon denganBoarding School System. Membentuk generasi penerus berlandaskan 5 pilar peradaban yaitu IMTAQ, IPTEK, Etika, Estetika & Harmoni.">
                    Tahun 2012 Pemda Kaur memfasilitasi peserta didik yang mempunyaisemangatbelajar yang tinggi untuk
                    mendapatkan layananpendidikan  yang baik, maka dibangunlah SMAN 10 Pentagon denganBoarding School
                    System. Membentuk generasi penerus berlandaskan 5 pilar peradaban yaitu IMTAQ, IPTEK, Etika,
                    Estetika & Harmoni.
                </p>
                <p
                    title="Tahun 2017 SMAN 10 Pentagon dikelola oleh Pemerintah Provinsi Bengkulu. Seiring bertambah waktu SMAN 10 Pentagon berkembang menjadi sekolah unggulan dan merupakan sekolah berasrama yang bebas dari sistem zonasi.">
                    Tahun 2017 SMAN 10 Pentagon dikelola oleh Pemerintah Provinsi Bengkulu. Seiring bertambah waktu SMAN
                    10 Pentagon berkembang menjadi sekolah unggulan dan merupakan sekolah berasrama yang bebas dari
                    sistem zonasi.
                </p>
            </div>
        </div>
                ...
                <ul class="list-disc pl-5 text-cstm-green-900">
                    <li>
                        ...
                        <span class="text-black">
                            Meningkatkan ketaqwaan kepada Tuhan dan mengaplikasikan dalam kehidupan sehari-hari.
                        </span>
                    </li>
                    <li>
                        ETIKA
                        <span class="text-black">
                            Membangun kepribadian yang baik dan menjunjung tinggi tata nilai dalam hidup
                    ...
                    <li>
                        HARMONI
                        <span class="text-black">
                            Mengembangkan sikap keselarasan hidup dengan Tuhan, sesama manusia
                            dan alam.
                        </span>
                    </li>
                    <li>
                        IPTEK
                        <span class="text-black">
                            Membekali siswa untuk menguasai ilmu pengetahuan dan teknologi sesuai bidangnya.
                        </span>
                    </li>
                    <li>
                        ESTETIKA
                        <span class="text-black">
                            Mengasah kepekaan dan meningkatkan apresiasi terhadap karya seni, budaya dan
                            kesusastraan.
                        </span>
                    </li>
                </ul>
    ...
    <div class="flex justify-center bg-cstm-green-50">
        <div
            ...
            <img src="/images/landing/organization.jpg" alt="Organisasi" class="my-3 w-full">
        </div>
    </div>
