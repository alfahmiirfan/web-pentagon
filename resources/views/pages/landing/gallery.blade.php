<x-layouts.landing title="Galeri | {{ config('app.name') }}">
    ...
    <div class="flex justify-center bg-cstm-green-50">
        <div
            ...
            <h1 title="Galeri Fasilitas, Kegiatan Kesiswaan" class="w-full text-2xl font-bold sm:text-3xl lg:text-4xl">
                Galeri Fasilitas, Kegiatan Kesiswaan
            </h1>
            <h1 title="Dan Kegiatan Asrama" class="w-full text-2xl font-bold sm:text-3xl lg:text-4xl">
                Dan Kegiatan Asrama
            </h1>
            <p title="Mengenal Fasilitas, Kegiatan Kesiswaan dan Aktivitas Asrama Lebih Dekat"
                class="w-full text-gray-500 sm:text-lg lg:text-xl">
                Mengenal Fasilitas, Kegiatan Kesiswaan dan Aktivitas Asrama Lebih Dekat
            </p>
        </div>
    </div>

    <div class="flex flex-col items-center justify-center gap-10 py-20" x-data="{
        data: {{ json_encode($studentActivities) }},
        currentPage: 1,
        ...
        <div
            ...
            <h3 title="Kegiatan Kesiswaan" class="text-xl font-bold sm:text-2xl lg:text-3xl">
                Kegiatan Kesiswaan
            </h3>
            <p title="Menumbuhkan Jiwa Kepemimpinan dan Kebersamaan" class="text-gray-500 max-sm:text-sm">
                Menumbuhkan Jiwa Kepemimpinan dan Kebersamaan
            </p>
        </div>
        <div class="flex w-full max-w-screen-xl items-center justify-center gap-3 px-5 md:gap-5 2xl:max-w-screen-2xl">
            ...
            <div class="flex flex-1 items-center justify-center gap-5">
                ...
                <template x-for="item in paginatedData">
                    <div
                        class="flex aspect-[16/12] w-full flex-col justify-end overflow-hidden rounded-xl bg-white shadow-lg sm:w-1/2">
