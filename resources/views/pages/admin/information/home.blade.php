<x-layouts.admin title="Informasi | Admin | {{ config('app.name') }}" x-data="{
                            ...
                            <div class="flex">
                                <div class="relative m-auto" x-data="{
                                    ...
                                    <div x-show="inFocus"
                                        ...
                                        <a
                                            x-bind:href="`{{ route(config('route.admin.information.edit'), ['information' => '###']) }}`
                                            .replace('###', item.id)">
                                            Edit
                                        </a>
    ...
    <x-modals.delete
        x-bind:href="selectedID ? `{{ route(config('route.admin.information.delete-action'), ['information' => '###']) }}`.replace(
            '###', selectedID) : ''" />
