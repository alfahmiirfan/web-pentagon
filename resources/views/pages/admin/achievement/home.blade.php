<x-layouts.admin title="Prestasi | Admin | {{ config('app.name') }}" x-data="{
    ...
    <div class="flex gap-3">
        ...
        <x-links.add href="{{ route(config('route.admin.achievement.add')) }}" />
    </div>
                            ...
                            <div class="flex">
                                <div class="relative m-auto" x-data="{
                                    ...
                                    <div x-show="inFocus"
                                        ...
                                        <a
                                            x-bind:href="`{{ route(config('route.admin.achievement.edit'), ['achievement' => '###']) }}`
                                            .replace('###', item.id)">
                                            Edit
                                        </a>
    ...
    <x-modals.delete
        x-bind:href="selectedID ? `{{ route(config('route.admin.achievement.delete-action'), ['achievement' => '###']) }}`.replace(
            '###', selectedID) : ''" />
