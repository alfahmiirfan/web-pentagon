<x-layouts.admin title="PTK | Admin | {{ config('app.name') }}" x-data="{
            ...
            <tbody>
                ...
                <template x-for="(item, index) in paginatedData">
                    <tr class="border-b *:p-1.5 last:border-none">
                        ...
                        <td class="text-center" x-text="item.position"></td>
                        <td>
                            ...
                            <div class="flex">
                                <div class="relative m-auto" x-data="{
                                    ...
                                    <div x-show="inFocus"
                                        ...
                                        <a
                                            x-bind:href="`{{ route(config('route.admin.ptk.edit'), ['ptk' => '###']) }}`.replace(
                                                '###', item.id)">
                                            Edit
                                        </a>
    ...
    <x-modals.delete
        x-bind:href="selectedID ? `{{ route(config('route.admin.ptk.delete-action'), ['ptk' => '###']) }}`.replace('###',
            selectedID) : ''" />
